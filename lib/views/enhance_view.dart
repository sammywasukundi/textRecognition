  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text('Agrandir', style: TextStyle(color: whiteColor)),
        ),
            ...
            child: Column(
              children: [
                        ...
                        child: Slider(value: contrast, onChanged: (v) {
                          ...
                          setState(() {
                            contrast;
                                ...
                                label: contrast.toStringAsFixed(2),activeColor: blueColor,),
                      ),
                    ],
                  ),
                ),
                Container(
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.brightness_1,color: blueColor,),
                      Expanded(
                        child: Slider(value: brightness, onChanged: (v) {
                          ...
                          setState(() {
                            brightness;
                                ...
                                label: brightness.toStringAsFixed(2),activeColor: blueColor),
                      ),
                    ],
                  ),
                ),
